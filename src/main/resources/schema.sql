...
-- Deletar sequências existentes, se houver
...
CREATE TABLE IF NOT EXISTS BATCH_STEP_EXECUTION (
    ...
    JOB_EXECUTION_ID BIGINT NOT NULL,
    CREATE_TIME TIMESTAMP NOT NULL,
    START_TIME TIMESTAMP NULL, -- Garantir que START_TIME não seja nulo
    END_TIME TIMESTAMP DEFAULT NULL,
    STATUS VARCHAR(10),
    COMMIT_COUNT BIGINT,
    READ_COUNT BIGINT,
...
CREATE TABLE IF NOT EXISTS public.domainproduct
(
    id serial,
    ...
    date_inclusion timestamp without time zone,
